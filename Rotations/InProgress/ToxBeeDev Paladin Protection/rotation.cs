...
namespace AimsharpWow.Modules
{
    ...
    public class ToxBeeDevPaladinProtection : Rotation        // <<<----- DON'T FORGET TO CHANGE THIS!!!
    {
        ...
        public override void LoadSettings()
        {
            ...
            Settings.Add(new Setting("Paladin: Protection by ToxBeeDev"));          // <<<----- DON'T FORGET TO CHANGE THIS!!!
        ...
        public override void Initialize()
        {
            ...
            ToxBeeDev.Settings.FolderName = "ToxBeeDev Paladin Protection";                 // <<<----- DON'T FORGET TO CHANGE THIS!!!
            ToxBeeDev.Settings.RotationName = "Paladin: Protection by ToxBeeDev";   // <<<----- DON'T FORGET TO CHANGE THIS!!!
            ToxBeeDev.Settings.Spec = "Paladin: Protection";                      // <<<----- DON'T FORGET TO CHANGE THIS!!!
