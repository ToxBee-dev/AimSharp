...
namespace AimsharpWow.Modules
{
    ...
    public class ToxBeeDevPaladinRetrubutation : Rotation        // <<<----- DON'T FORGET TO CHANGE THIS!!!
    {
        ...
        public override void LoadSettings()
        {
            ...
            Settings.Add(new Setting("Paladin: Retrubutation by ToxBeeDev"));          // <<<----- DON'T FORGET TO CHANGE THIS!!!
        ...
        public override void Initialize()
        {
            ...
            ToxBeeDev.Settings.FolderName = "ToxBeeDev Paladin Retrubutation";          // <<<----- DON'T FORGET TO CHANGE THIS!!!
            ToxBeeDev.Settings.RotationName = "Paladin: Retrubutation by ToxBeeDev";    // <<<----- DON'T FORGET TO CHANGE THIS!!!
            ToxBeeDev.Settings.Spec = "Paladin: Retrubutation";                         // <<<----- DON'T FORGET TO CHANGE THIS!!!
