...
namespace AimsharpWow.Modules
{
    ...
    public class ToxBeeDevWarriorFury : Rotation                           // <<<----- DON'T FORGET TO CHANGE THIS!!!
    {
        ...
        public override void Initialize()
        {
            ...
            // Create a macro for Spear of Bastion with effects on the player himself
            Helper.AddCastMacro("SpearOfBastionPlayer", "player", Helper.rootObject.GetStringById(376079));
            // Create a macro for Ravager with effects on the player himself
            ...
            // T-SetBonus list, this is needed to later use Helper.HasSetBonus(int pice) to determine how many set parts have been drawn. 
            // The items must be available in the language.json.
        ...
        public override bool CombatTick()
        {
            ...
            Spell SpearOfBastion = new Spell(376079, "player", false, true);
            ...
            if (Helper.InFightCheck() || GetCheckBox("Test on Dummy"))
            {
                ...
                if (!Helper.IsCustomCodeOn("NoCooldowns") && (Helper.HasTalent(383916) && SpearOfBastion.SpellCooldown() < 1000 || Avatar.SpellCooldown() > 40000 || !Helper.HasTalent(107574) || Target.TimeToDie > 9)) if (Recklessness.Cast()) return true;
                ...
                if (!Helper.IsCustomCodeOn("NoCooldowns") && (BuffEnrage.HasBuff() && (BuffFuriousBloodthirst.HasBuff() && Helper.HasTalent(390135)) || !Helper.HasTalent(390135) || Target.TimeToDie > 9 || Player.EnemiesInMelee > 1 || !Helper.HasSetBonus(2))) if (SpearOfBastion.CastMacro("SpearOfBastionPlayer")) return true;
